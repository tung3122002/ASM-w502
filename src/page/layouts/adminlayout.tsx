 ...
 <div className="container">
    <div>
      <div className="row">
        <div className="col-2">
          <aside>
  <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{width: 200,height: 900}}>
  ...
  <ul className="nav nav-pills flex-column mb-auto">
    <li className="nav-item">
      <a href="admin/products" className="nav-link active" aria-current="page">
